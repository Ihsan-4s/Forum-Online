                ...
                <form id="threadForm" method="POST" action="{{ route('drafts.update', $draft->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                            placeholder="Masukkan judul diskusi" value="{{ $draft['title'] }}">
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" rows="5" class="form-control @error('content') is-invalid @enderror"
                            placeholder="Tulis isi diskusi kamu">{{ $draft['content'] }}</textarea>
                        @error('content')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" >Jadikan
                                    Draft</button>
